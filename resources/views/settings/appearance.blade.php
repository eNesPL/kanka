...
@section('content')
    ...
    <div class="max-w-3xl">
        <h1 class="mb-5">{{ __('settings.menu.appearance') }}</h1>
        <p class="text-lg">
        ...
        <div class="{{ $boxClass }} {{ $highlight === 'pagination' ? 'drop-shadow border-accent border-solid border-2' : '' }}">
            ...
            {!! Form::select('pagination', $paginationOptions, null, ['class' => 'form-control self-end w-full border rounded p-2'], $paginationDisabled) !!}
        </div>
        ...
        <div class="{{ $boxClass }} {{ $highlight === 'campaign-switcher' ? 'drop-shadow border-accent border-solid border-2' : '' }}">
            ...
            ], auth()->user()->campaignSwitcherOrderBy, ['class' => 'form-control self-end w-full border rounded p-2']) !!}
        </div>
        ...
        <button class="rounded btn-primary text-white w-full uppercase text-center py-2 text-lg">
            <i class="fa-solid fa-save" aria-hidden="true"></i>
