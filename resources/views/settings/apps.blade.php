        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="flex gap-2 items-center">
                    <div class="flex-0">
                        <i class="fab fa-discord fa-3x text-indigo-400" aria-hidden="true"></i>
                    </div>
                    <div class="grow">
...
@section('modals')
    @parent
    <dialog class="dialog rounded-2xl text-center" id="remove-discord" aria-modal="true" aria-labelledby="helpModalLabelremove-discord">
        <header>
