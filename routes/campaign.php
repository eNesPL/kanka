...
Route::get('/modules', [\App\Http\Controllers\Campaign\ModuleController::class, 'index'])->name('campaign.modules');
Route::post('/modules/toggle/{module?}', [\App\Http\Controllers\Campaign\ModuleController::class, 'toggle'])->name('campaign.modules.toggle');
